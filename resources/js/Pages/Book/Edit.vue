<template>
    ...
    <Layout title="Edit Book ">
        <form @submit.prevent="form.patch(`/book/${book.id}`)" class="bg-white rounded-md p-3 mt-3">
            <div>
                <label>Title</label>
            ...
            <div class="mt-2">
                ...
                <input type="number" placeholder="published year" v-model.number="form.published_year" class="rounded w-full p-2 border border-2 border-grey-300 "/>
